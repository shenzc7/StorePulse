...
// Navigation items in user-preferred order:
...
export function Layout() {
  ...
  return (
    <div className="min-h-screen bg-surface-100">
      ...
      <aside className="hidden lg:flex flex-col fixed left-0 top-0 h-full w-64 bg-white border-r border-border shadow-sm z-20">
        {/* Logo Section */}
        <div className="h-16 flex items-center px-6 border-b border-border">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-lg font-semibold text-ink-900">StorePulse</h1>
          </div>
        </div>
        {/* Navigation */}
        ...
        <div className="p-4 border-t border-border">
          <div className="px-3 py-2 rounded-xl bg-surface-100 border border-border">
            <div className="flex items-center gap-2 mb-1">
              <div className="w-2 h-2 rounded-full bg-accent-500"></div>
              <span className="text-xs font-medium text-ink-900">System Status</span>
            </div>
            <p className="text-xs text-ink-600">All systems operational</p>
          </div>
        </div>
      </aside>
      {/* Main Content Area */}
      <div className="lg:ml-64 min-h-screen">
        {/* Mobile Header */}
        <header className="lg:hidden sticky top-0 z-10 h-16 flex items-center justify-between px-4 bg-white border-b border-border shadow-sm">
          <div className="flex items-center gap-2">
            ...
            <span className="text-base font-semibold text-ink-900">StorePulse</span>
          </div>
        </header>
        {/* Main Content */}
